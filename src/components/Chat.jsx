...
const Chat = ({
  ...
  <div className="flex flex-col sm:flex-row sm:items-center gap-3">
    {/* Label */}
    <label htmlFor="model-select" className="text-gray-800 font-medium text-sm sm:text-base">
      AI Model:
    </label>
    ...
    <select
      id="model-select"
      className="w-full sm:w-64 bg-white border border-gray-300 text-gray-800 text-sm sm:text-base font-medium rounded-lg px-4 py-2 shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 transition disabled:bg-gray-100 disabled:text-gray-400 disabled:cursor-not-allowed"
      value={selectedModel}
